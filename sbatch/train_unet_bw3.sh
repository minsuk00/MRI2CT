...
# --- Configuration Area ---
# FRESH bone-weight-sweep run: same config as nbn71048 (center_wise unet, L1+SSIM+Dice,
# norm batch, bs8, 800ep) EXCEPT dice_bone_w. Runs on the new CADS 35-class dice
# (teacher/seg/n_classes come from DEFAULT_CONFIG). Twin of train_unet_bw10.sh (bw 10.0).
PREFIX="unet"
...
TAGS="bs8,bwsweep" # Comma-separated extra WandB tags
